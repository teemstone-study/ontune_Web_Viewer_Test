...
//                 {e.p_id == null && (
//                   <div
//                     className="div_Main_Background" name={"root_"+e.id} id={e.id} onDragOver={onDragOver_div_event} onDragEnd={onDragEnd_div_event} onDragEnter={onDragenter_div_event}// onDrop={onDrop_div_event} 
//                     style={{ inset: `0%` }}>
//                   </div>
//                   )
//                 }
...
//                 >
//                   {/* draggable="true" onDragStart={onDragStart_div_event}>   */}
//                   <div className="div_Title" style={{cursor: 'default'}}> 
  ...
  <!-- <li>{i + 1} : {item.div_type}</li>  -->
	...
	{#if item.node_type == "P"}
		...
		{#if item.p_id == null}
			<!-- <h1>Hello {name}!</h1> -->
			<div
				class="div_Main_Background" name={"root_"+item.id} id={item.id} 
				style="inset: `0%`">
			</div>			
		{:else}
			<!-- <div>No name!</div> -->
